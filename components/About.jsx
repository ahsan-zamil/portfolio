...
const About = ({ isDarkMode }) => {
    return (
        <motion.div id='about' className='w-full px-2 sm:px-[8%] md:px-[12%] py-10 scroll-mt-20'
            initial={{ opacity: 0 }}
        ...
        >
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    <Image src={assets.ahsan_image} alt='user' className='w-full rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.15)] dark:shadow-[0_0_50px_rgba(255,255,255,0.07)] transition-all duration-300 hover:shadow-[0_0_60px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_0_60px_rgba(255,255,255,0.1)]' />
                </motion.div>
                <motion.div
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    ...
                    <motion.ul
                        ...
                        className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-2xl pr-2'>
